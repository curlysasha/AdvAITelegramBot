...
DEFAULT_SYSTEM_MESSAGE: List[Dict[str, str]] = [
    {
        ...
        "content": (
            ...
            "\n\n"
            "Если пользователь просит сгенерировать изображение, обязательно предложи ему использовать команду /img с английским описанием и напиши что её нужно вставить в сообщение. "
            "Пример ответа:\n"
